...
export default defineConfig({
  ...
  themeConfig: {
    ...
    siteTitle: 'Guna Sekhar',
    socialLinks: [
      { icon: 'github', link: 'https://github.com/GunaSekhar8554/GunaSekhar8554' },
    ],
    editLink: {
      pattern: 'https://github.com/GunaSekhar8554/GunaSekhar8554/edit/main/:path',
      text: 'Edit this page on GitHub',
    },
    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright © 2025 Guna Sekhar.',
    },
    nav: [
      { text: 'Blog', link: '/blog/' },
      { text: 'Docs', link: '/docs/' },
      { text: 'Examples', link: '/examples/' },
      { text: 'GitHub', link: 'https://github.com/GunaSekhar8554/GunaSekhar8554' },
    ],
    sidebar: {
      '/docs/': sidebars(),
    ...
    algolia: {
      appId: 'LQE45NS4IX',
      apiKey: 'a595615a901243ae8b0f04ff5760b484',
      indexName: 'Port',
    },
  },
  head: [
    ...
    ['meta', { property: 'twitter:domain', content: 'gunasekhar.dev' }],
    [
      'meta',
      {
  ...
  titleTemplate: ':title - Guna Sekhar',
  vite: {
    plugins: [
      groupIconVitePlugin({
        customIcon: {
